...
- **True Elliptic Fourier Descriptors (EFDs)**  
  Supports both conventional and *true normalized* EFDs (following @wu2024reliablesuperiorellipticfourier), allowing morphometric analysis that preserves biologically meaningful orientation and symmetry.
