...
Download the latest release from [Releases](https://github.com/username/leaf-contour-efd/releases) and run the executable.  
*(Windows: `LeafContourEFD.exe`, macOS: `LeafContourEFD.app`)*
...
# 4. Install the LeafContourEFD package in editable mode
uv pip install -e .

# 5. Launch the application
uv run leaf-contour-efd
```
